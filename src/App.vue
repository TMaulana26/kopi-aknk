...
<template>
  <div class="min-h-screen bg-background text-foreground font-sans selection:bg-primary/30 overflow-x-hidden">
    <TheNavbar />
...
.shadow-3xl {
  box-shadow: 0 50px 100px -20px rgba(0, 0, 0, 0.5), 0 30px 60px -30px rgba(0, 0, 0, 0.7);
}
